...
angular.module('fg').run(['$templateCache', function($templateCache){
  ...
  $templateCache.put('angular-form-gen/field-templates/default/fileupload.ng.html', '<div class=\"input-group image-preview\"><input type=\"text\" class=\"form-control image-preview-filename\" fg-field-input=\"\" id=\"{{ field.$_id }}\" ng-model=\"form.data[field.schema.name]\" ng-required=\"field.schema.validation.required\" disabled=\"disabled\"><div class=\"input-group-btn\"><button type=\"button\" class=\"btn btn-default image-preview-clear\" style=\"display:none;\"><span class=\"glyphicon glyphicon-remove\"></span> Clear</button><div class=\"btn btn-default image-preview-input\" fg-field-upload=\"\"><span class=\"glyphicon glyphicon-folder-open\"></span> <span class=\"image-preview-input-title\">Browse</span> <input type=\"file\" accept=\"image/png, image/jpeg, image/gif\" name=\"input-file-preview\"></div></div></div>');
  ...
  $templateCache.put('angular-form-gen/field-templates/properties/fileupload.ng.html', '<div fg-tabs-pane=\"Propriedades\"><div fg-property-field-common=\"{ fieldname: false, mask: false, displayname: false, placeholder: false, tooltip: true }\"></div><div fg-property-field-value=\"\"><div class=\"input-group image-preview\"><input type=\"text\" class=\"form-control image-preview-filename\" name=\"fieldValue\" ng-model=\"field.value\" ng-required=\"field.schema.validation.required\" disabled=\"disabled\"><div class=\"input-group-btn\"><button type=\"button\" class=\"btn btn-default image-preview-clear\" style=\"display:none;\"><span class=\"glyphicon glyphicon-remove\"></span> Clear</button><div class=\"btn btn-default image-preview-input\"><span class=\"glyphicon glyphicon-folder-open\"></span> <span class=\"image-preview-input-title\">Browse</span> <input type=\"file\" accept=\"image/png, image/jpeg, image/gif\" name=\"input-file-preview\"></div></div></div></div></div><div fg-tabs-pane=\"Validações\"><div fg-property-field-validation=\"{ required: true, minlength: false, maxlength: false, pattern: false }\"></div></div>');
